...
// -------------------------
// Asociar artículos a sucursales (SucursalArticulo)
// -------------------------
// Asumimos que sucursales (sucursal1..sucursal4) ya creadas en Traza1
...
SucursalArticulo sa3 = SucursalArticulo.builder()
        ...
        sucursalArticuloRepository.save(sa3);

// -------------------------
// CONSULTAS / SALIDAS REQUERIDAS
// -------------------------
...
// Mostrar todos los artículos manufacturados
        System.out.println("\nTodos los artículos manufacturados:");
...
// Buscar un artículo manufacturado por ID (usa repository)
        System.out.println("\nBuscar Artículo Manufacturado ID = 1:");
Optional<ArticuloManufacturado> articuloEncontrado = articuloManufacturadoRepository.findById(1L);
        ...
        // Actualizar un artículo manufacturado por ID (ejemplo actualizar pizza id 1)
        System.out.println("\nActualizar Artículo Manufacturado (Pizza Hawaina) - ejemplo:");
...
Optional<ArticuloManufacturado> articuloVerificado = articuloManufacturadoRepository.findById(1L);
        ...
        System.out.println("\nEliminar Artículo Manufacturado ID = 1 (ejemplo):");
...
Optional<ArticuloManufacturado> articuloEliminado = articuloManufacturadoRepository.findById(1L);
        ...
        System.out.println("El artículo manufacturado con ID 1 ha sido eliminado.");
                ...
                System.out.println("\nTodos los artículos manufacturados restantes:");
todosLosArticulosManufacturados = articuloManufacturadoRepository.findAll();
        todosLosArticulosManufacturados.forEach(System.out::println);

// Mostrar sucursales y su stock de articulos (SucursalArticulo)
        System.out.println("\nArtículos por sucursal (SucursalArticulo):");
List<SucursalArticulo> allSA = sucursalArticuloRepository.findAll();
        allSA.forEach(System.out::println);

// Mostrar empresas y sus sucursales (traza1)
